        ...
        <div className="border border-gray-200 rounded-xl p-6">
            <div className="flex items-center gap-3">
                ...
                <span className={`text-xs px-2.5 py-1 rounded-full font-mono ${
                    app.status === "in_progress" ? "bg-amber-50 text-amber-600" :
                    app.status === "complete" ? "bg-green-50 text-green-600" :
            ...
            <p className="text-xs text-gray-500 font-mono uppercase mt-1.5 tracking-wide">
                {app.category} · {app.dueDate} · <span className={app.daysLeft <= 7 ? "text-red-500":app.daysLeft <= 30 ? "text-amber-000":"text-green-600"}>{app.daysLeft} days</span>
